  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 sticky top-24">
      <div className="bg-card-number rounded-lg p-4 mb-6">
        <p className="text-sm text-white/80 mb-1">Precio por boleto</p>
      ...
      <div className="mb-6">
        <h3 className="text-lg font-bold text-text-light mb-4">Resumen</h3>
        <div className="bg-background-light rounded-lg p-4">
          <p className="text-sm text-gray-600 mb-2">Números seleccionados:</p>
          {numerosSeleccionados.length > 0 ? (
            <p className="text-base font-semibold text-text-light mb-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center rounded-lg h-12 px-4 bg-primary hover:bg-primary/90 text-text-light text-base font-bold transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Apartar números
      </button>
    </div>
