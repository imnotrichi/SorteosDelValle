    ...
    <div className="min-h-screen bg-background-light">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="inline-block px-4 py-2 text-sm font-bold rounded-full bg-green-100 text-green-700">
            Activo
          </span>
        </div>
        ...
        <div className="bg-card-number rounded-xl p-6 shadow-sm mb-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center justify-center rounded-lg h-14 px-8 bg-primary hover:bg-primary/90 text-text-light text-base font-bold transition-colors shadow-lg"
            >
        ...
        <div>
          <h3 className="text-2xl font-bold text-text-light mb-6">Premios</h3>
